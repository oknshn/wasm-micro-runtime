/*** file name: thesis-lib.h  ***/

static const uint32_t f32_input1[256] = {
...
static const uint32_t f32_input2[256] = {
...
void test_benchmark_vec_add_f32(int *f32_input1, int f32_input1_len, int *f32_input2, int f32_input2_len);
void test_benchmark_vec_sub_f32(int *f32_input1, int f32_input1_len, int *f32_input2, int f32_input2_len);
void test_benchmark_vec_mul_f32(int *f32_input1, int f32_input1_len, int *f32_input2, int f32_input2_len);
void test_benchmark_vec_abs_f32(int *f32_input1, int f32_input1_len);
