...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HAL_NMSIS_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_QEMU_RISCV64_QEMU_VIRT_RISCV64, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_QEMU_VIRT_RISCV64, 1);
